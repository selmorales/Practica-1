...
public class SalesRegister { // o static?
	...
	/*static significa que cada atributo o método es compartido por todos
	los objetos, y se puede usar sin crear un objeto */
	...
	public static ClothingItem  processSale(Inventory inventory, String name, char size) {
		...
		if (itemExtraido != null) {
			...
			String printy = String.format("Venta procesada: %s (%.2f €)", itemExtraido.getName(), itemExtraido.getPrice());
